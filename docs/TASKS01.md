<!-- task-status: partial; date: 2026-09-11 -->
> Traité le 2026-09-11, en partie : les trois défauts d'interface sont corrigés et testés ; la page de connexion a sa spec et son plan, relus, et son implémentation est en cours. Détail en fin de fichier.
